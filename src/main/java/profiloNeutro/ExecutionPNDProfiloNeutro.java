...
public class ExecutionPNDProfiloNeutro {
    ...
    public static void linkedin() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("username")).sendKeys("luigirinaldi1998@gmail.com");
            driver.findElement(By.id("password")).click();
            driver.findElement(By.id("password")).sendKeys("Luigi1998!");
    ...
    public static void euronics() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("miniUserId")).click();
            driver.findElement(By.id("miniUserId")).sendKeys("luigirinaldi1998@gmail.com");
            ...
            driver.findElement(By.id("miniPassword")).click();
            driver.findElement(By.id("miniPassword")).sendKeys("Luigi1998!");
    ...
    public static void foodJustEat() throws InterruptedException {
        try {
            ...
            // Credential
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Email"))).sendKeys("luigirinaldi1998@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Password"))).sendKeys("Luigi1998!");
    ...
    public static void booking(){
        ...
        // Credential
        wait.until(ExpectedConditions.elementToBeClickable(By.id("username"))).sendKeys("luigirinaldi1998@gmail.com");
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
    ...
    public static void facebook() throws InterruptedException {
        ...
        try {
            ...
            Thread.sleep(2000);
            wait.until(ExpectedConditions.elementToBeClickable(By.id("email"))).sendKeys("luigirinaldi1998@gmail.com"); // Email
            // section
            wait.until(ExpectedConditions.elementToBeClickable(By.id("pass"))).sendKeys("Luigi1998!"); // Password sections
        ...
        try {
            ...
            try {
                ...
                wait.until(ExpectedConditions.elementToBeClickable(By.name("username")))
                        .sendKeys("luigirinaldi1998@gmail.com");
                wait.until(ExpectedConditions.elementToBeClickable(By.name("password"))).sendKeys("Luigi1998!");
    ...
    public static void amazon() throws InterruptedException {
        ...
        try {
            ...
            // Creditial
            wait.until(ExpectedConditions.elementToBeClickable(By.id("ap_email"))).sendKeys("luigirinaldi1998@gmail.com");
            driver.findElement(By.id("continue")).click();
            wait.until(ExpectedConditions.elementToBeClickable(By.id("ap_password"))).sendKeys("Luigi1998!");
            driver.findElement(By.id("signInSubmit")).click();


            // Skipping the phone number section
            try {
                wait.until(ExpectedConditions.elementToBeClickable(By.id("ap-account-fixup-phone-skip-link"))).click();
            } catch (Exception e) {
            }
    ...
    public static void samsung() throws InterruptedException {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.id("iptLgnPlnID")))
                    .sendKeys("luigirinaldi1998@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.id("iptLgnPlnPD"))).sendKeys("Luigi1998!");
    ...
    public static void monsterJob() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.name("email"))).sendKeys("luigirinaldi1998@gmail.com");
        wait.until(ExpectedConditions.elementToBeClickable(By.name("password"))).sendKeys("Luigi1998!");
