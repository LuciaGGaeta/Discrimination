...
public class ExecutionPNDStereotipoDonna {
    ...
    public static void linkedin() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("username")).sendKeys("luciarossoro1998@gmail.com");
            driver.findElement(By.id("password")).click();
            driver.findElement(By.id("password")).sendKeys("Lucia1998!");
    ...
    public static void euronics() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("miniUserId")).click();
            driver.findElement(By.id("miniUserId")).sendKeys("luciarossoro1998@gmail.com");
            ...
            driver.findElement(By.id("miniPassword")).click();
            driver.findElement(By.id("miniPassword")).sendKeys("Lucia1998!");
    ...
    public static void foodJustEat() throws InterruptedException {
        try {
            ...
            // Credential
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Email"))).sendKeys("luciarossoro1998@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Password"))).sendKeys("Lucia1998!");
    ...
    public static void booking(){
        ...
        try {
            ...
            // Credential
            wait.until(ExpectedConditions.elementToBeClickable(By.id("username"))).sendKeys("luciarossoro1998@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
    ...
    public static void facebook() throws InterruptedException {
        ...
        try {
            ...
            Thread.sleep(2000);
            wait.until(ExpectedConditions.elementToBeClickable(By.id("email"))).sendKeys("LuciaRossoro1998@gmail.com"); // Email
            // section
            wait.until(ExpectedConditions.elementToBeClickable(By.id("pass"))).sendKeys("Lucia1998!"); // Password sections
        ...
        try {
            ...
            try {
                ...
                wait.until(ExpectedConditions.elementToBeClickable(By.name("username")))
                        .sendKeys("LuciaRossoro1998@gmail.com");
                wait.until(ExpectedConditions.elementToBeClickable(By.name("password"))).sendKeys("Lucia1998!");
    ...
    public static void amazon() throws InterruptedException {
        ...
        try {
            ...
            // Creditial
            wait.until(ExpectedConditions.elementToBeClickable(By.id("ap_email"))).sendKeys("LuciaRossoro1998@gmail.com");
            driver.findElement(By.id("continue")).click();
            wait.until(ExpectedConditions.elementToBeClickable(By.id("ap_password"))).sendKeys("Lucia1998!");
    ...
    public static void samsung() throws InterruptedException {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.id("iptLgnPlnID")))
                    .sendKeys("LuciaRossoro1998@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.id("iptLgnPlnPD"))).sendKeys("Lucia1998!");
    ...
    public static void monsterJob() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.name("email"))).sendKeys("LuciaRossoro1998@gmail.com");
        wait.until(ExpectedConditions.elementToBeClickable(By.name("password"))).sendKeys("Lucia1998!");
