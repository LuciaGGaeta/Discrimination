...
public class ExecutionUomoStereotipoDonna {
    ...
    public static void linkedin() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("username")).sendKeys("saveriossantoro1999@gmail.com");
            driver.findElement(By.id("password")).click();
            driver.findElement(By.id("password")).sendKeys("Saverio99!");
    ...
    public static void euronics() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("miniUserId")).click();
            driver.findElement(By.id("miniUserId")).sendKeys("saveriossantoro1999@gmail.com");
            ...
            driver.findElement(By.id("miniPassword")).click();
            driver.findElement(By.id("miniPassword")).sendKeys("Saverio99!");
    ...
    public static void foodJustEat() throws InterruptedException {
        try {
            ...
            // Credential
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Email"))).sendKeys("saveriossantoro1999@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Password"))).sendKeys("Saverio99!");
    ...
    public static void booking(){
        ...
        try {
            ...
            // Credential
            wait.until(ExpectedConditions.elementToBeClickable(By.id("username"))).sendKeys("saveriossantoro1999@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
