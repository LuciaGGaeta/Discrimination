...
public class ExecutionPNDStereotipoUomo {
    ...
    public static void linkedin() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("username")).sendKeys("marraluca1998@gmail.com");
            driver.findElement(By.id("password")).click();
            driver.findElement(By.id("password")).sendKeys("Luca1998!");
    ...
    public static void euronics() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("miniUserId")).click();
            driver.findElement(By.id("miniUserId")).sendKeys("marraluca1998@gmail.com");
            ...
            driver.findElement(By.id("miniPassword")).click();
            driver.findElement(By.id("miniPassword")).sendKeys("Luca1998!");
    ...
    public static void foodJustEat() throws InterruptedException {
        try {
            ...
            // Credential
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Email"))).sendKeys("marraluca1998@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.id("Password"))).sendKeys("Luca1998!");
    ...
    public static void booking(){
        ...
        try {
            ...
            // Credential
            wait.until(ExpectedConditions.elementToBeClickable(By.id("username"))).sendKeys("marraluca1998@gmail.com");
            wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
